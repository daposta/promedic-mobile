...
export class ResponderAuthService{
	...
	private loginUrl = this.globals.RESPONDER_LOGIN_URL;
	private logoutURL = this.globals.RESPONDER_LOGOUT_URL;
	private userProfile = this.globals.RESPONDER_PROFILE_URL;
